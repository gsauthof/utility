...
argv[2]: hello
argv[3]: world
'''.format(core_file, core_file[core_file.rfind('.')+1:], exe)
...
# XXX test: core file without sections (as generated by systemd-coredump)
# XXX test: PPC big-endian core, add the core file
# XXX test: add x86-32/64 core files into repo
